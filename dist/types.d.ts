...
export type ComponentFactory<T extends Record<string, unknown> = Record<string, unknown>> = (ctx: ComponentContext) => T;
export type ComponentDefinition<T extends Record<string, unknown> = Record<string, unknown>> = {
